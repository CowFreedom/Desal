...
#g++ -o main.bin main.cpp flux_models.o math.o -pthread -O3 -std=c++20 -fmodules-ts -march=native 
g++ -o main.bin main.cpp -pthread -O3 -std=c++20 -fmodules-ts -march=native
